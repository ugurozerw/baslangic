      ...
      <div className="form-container">
        {currentStep === 1 && (
          <div className={`form-step step-${currentStep}`}>
            ...
            <input
              ...
              className="form-input"
            />
            <button onClick={nextStep1} className="form-button">
              İleri
            </button>
          </div>
        )}
        ...
        {currentStep === 2 && (
          <div className={`form-step step-${currentStep}`}>
            ...
            <input
              ...
              className="form-input"
            />
            <button onClick={prevStep} className="form-button">
              Geri
            </button>
            <button onClick={nextStep2} className="form-button">
              İleri
            </button>
          </div>
        )}
        ...
        {currentStep === 3 && (
          <div className={`form-step step-${currentStep}`}>
            ...
            <button onClick={nextStep3} className="form-button">
              İleri
            </button>
          </div>
        )}
        ...
        {currentStep === 4 && (
          <div className={`form-step step-${currentStep}`}>
            ...
            <button onClick={nextStep4} className="form-button">
              İleri
            </button>
          </div>
        )}
